...
public class ReadSimulator {
	...
	public static void main(String[] args) throws Exception
	{
		...
		GenomeSimulator gs = new GenomeSimulator(fn);
		ReadSimulator rs = new ReadSimulator(gs, SNP, insertion, deletion, meanLength, coverage, false);
		rs.printToFile(ofn);
	}

	ReadSimulator(GenomeSimulator ref, double snpRate, double insRate, double delRate, int meanLength, int coverage, boolean alwaysForward)
	{
		r = new Random(654321);
