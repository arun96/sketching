...
public class ReadScreenerNovel extends Screener {

  // Main function for screening reads
  ReadScreenerNovel(Screen sg) throws Exception
  {
    ...
    if (Settings.IN_CHUNKS){
     ...
     for (int r = 0; r < numReadSets; r++){
       ...
       while (!fully_read){
         ...
         //Screen these reads
         ParallelScreenerNovel ps = new ParallelScreenerNovel(sg, reads, r, read_start);
         ps.run();
